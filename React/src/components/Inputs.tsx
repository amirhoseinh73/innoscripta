interface InputFocusInterface extends React.InputHTMLAttributes<HTMLInputElement> {
  className?: string
}

export const InputFocus = function ({ className, ...htmlAttr }: InputFocusInterface) {
  return (
    <input
